        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/team" className="text-base text-gray-600 hover:text-primary">
                  Team
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-base text-gray-600 hover:text-primary">
                  Careers
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/cookies" className="text-base text-gray-600 hover:text-primary">
                  Cookie Policy
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/register" className="text-base text-gray-600 hover:text-primary">
                  Sign Up
                </Link>
              </li>
              <li>
                <Link to="/login" className="text-base text-gray-600 hover:text-primary">
                  Log In
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/create-event" className="text-base text-gray-600 hover:text-primary">
                  Create an Event
                </Link>
              </li>
            </ul>
